...
describe("Jokers", function () {
  ...
  it("Should be able to mint NFT token with sequential IDs, with respective owners and URIs", async function () {
    let metaURI = "https://example.com/item-id-8u5h2m.json";
    await jokers.awardItem(accounts[1].address, metaURI);
    ...
    await jokers.awardItem(accounts[2].address, metaURI2);
